...
\textbf{Acknowledgements.} {[}removed for peer review{]}

\textbf{Open Practices Statement.} All code, data, and materials are available on OSF (\url{https://osf.io/zeqka/?view_only=e027502f4e7f49408cfb2cba38f7b506}).

\textbf{CRediT author statement.} {[}removed for peer review{]}
...
{\centering \includegraphics{Retest_submission1_anonymized_files/figure-latex/unnamed-chunk-5-1} 
...
{\centering \includegraphics[width=5in]{Retest_submission1_anonymized_files/figure-latex/unnamed-chunk-8-1} 
