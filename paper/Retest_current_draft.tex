...
Neither the Pearson correlation coefficients nor the coefficients of the multilevel analysis were significant, all \emph{p}-values \textgreater{} .286.
...
In part due to a decrease in sample size, only one of these correlations was statistically significant (namely when requiring a minimum of 6 trial pairs): 2 valid trial pairs, \(t(152) = 0.90\), \(p = .367\); 4 valid trial pairs, \(t(143) = 1.03\), \(p = .306\); 6 valid trial pairs, \(t(98) = 2.23\), \(p = .028\); 8 valid trial pairs - all trials in both sessions - \(t(22) = 1.68\), \(p = .108\).
