...
\hypersetup{
  pdftitle={Limited evidence of test-retest reliability in infant-directed speech preference in a large pre-registered infant experiment},
...
\title{Limited evidence of test-retest reliability in infant-directed speech preference in a large pre-registered infant experiment}
...
Trials were also excluded if the minimum looking time of 2 s was not met (11.80\% of the remaining trials).
