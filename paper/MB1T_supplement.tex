...
In order to further investigate sources of variance, we conducted a simulation with subsets of participants who started to show a significant correlation (see Figure 7, e.g., the 113 participants with 12 trials each), resampling increasingly larger numbers of trials for each subset and computing the average resulting test-retest correlation. sampling subsets of trials for those participants (in increments of two, i.e., 2, 4, 6, and 8 trial pairs).
...
\caption{Correlations in average looking time (in s) between Session 1 and 2 by item.}\label{fig:sfig10}
\end{figure}
...
\caption{\label{tab:unnamed-chunk-43}Linear mixed-effects model results predicting IDS preference in Session 2 from IDS preference in Session 1 at the stimulus level.}
...
\caption{Correlations between average looking time (in s) and IDS preference in (A) Session 1 and (B) Session 2.}\label{fig:fig10}
\end{figure}
...
\caption{Correlations between average looking time (in s) and IDS preference for infants with shorter looking (left panel) and longer looking (right panel).}\label{fig:fig11}
\end{figure}

\hypertarget{s11.-changes-in-looking-time-and-preferential-looking-across-trials}{%
\section{S11. Changes in looking time and preferential looking across trials}\label{s11.-changes-in-looking-time-and-preferential-looking-across-trials}}
...
\hypertarget{s11.2.-changes-in-preferential-looking-across-trials}{%
\subsection{S11.2. Changes in preferential looking across trials}\label{s11.2.-changes-in-preferential-looking-across-trials}}
...
\caption{IDS preference (IDS-ADS) for pairs of (adjacent) trials, for Session 1 (left panel) and Session 2 (right panel). Error bars represent +1/-1 SEs. The blue line represents a loess fit through the data with 95\% confidence bands.}\label{fig:fig14}
\end{figure}
