...
{\centering \includegraphics{MB1T_supplement_files/figure-latex/unnamed-chunk-19-1} 

}

\caption{Correlations in average looking time (in ms) between Session 1 and 2 (A) overall, (B) by condition, and (C) by item.}\label{fig:unnamed-chunk-19}
\end{figure}
