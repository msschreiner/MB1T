...
In order to further investigate sources of variance, we conducted a simulation with the subset of participants who started to show a significant correlation (see Figure 7, e.g., the 98 participants with 12 trials each), sampling subsets of trials for those participants (in increments of two, i.e., 2, 4, 6, and 8 trail pairs).

\begin{figure}
\centering
\includegraphics{MB1T_supplement_files/figure-latex/fig8-1.pdf}
\caption{\label{fig:fig8}Results of the simulation of randomly selected trial pairs of participants that contributed at least 12 valid trails for the test and retest session. (A) shows the mean Pearson correlation for participants that contributed at least 12 valid trail pairs, and (B) shows the mean Pearson correlation for participants that contributed 16 valid trail pairs.}
\end{figure}
