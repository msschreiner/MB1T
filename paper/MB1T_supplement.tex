...
\caption{\label{tab:unnamed-chunk-44}Results of the final linear mixed-effects model predicting trial-by-trial log looking time from all within- and between-participant predictors of interest.}

\begin{tabular}{llllll}
\toprule
term & \multicolumn{1}{c}{$\hat{\beta}$} & \multicolumn{1}{c}{95\% CI} & \multicolumn{1}{c}{$t$} & \multicolumn{1}{c}{$\mathit{df}$} & \multicolumn{1}{c}{$p$}\\
\midrule
Intercept & 2.33 & {}[2.04, 2.62] & 15.70 & 151.28 & < .001\\
Trial Number & -0.15 & {}[-0.21, -0.10] & -5.30 & 145.58 & < .001\\
Session & 0.15 & {}[0.11, 0.18] & 7.93 & 167.25 & < .001\\
Condition (IDS vs. ADS) & -0.04 & {}[-0.04, -0.03] & -14.00 & 164.41 & < .001\\
Previous Trial Looking Time & 0.00 & {}[0.00, 0.01] & 2.31 & 3872.97 & .021\\
Age (averaged across sessions) & 0.00 & {}[0.00, 0.00] & -2.97 & 151.42 & .003\\
NAE status & -0.16 & {}[-0.28, -0.04] & -2.62 & 152.62 & .010\\
Method (HPP vs. ET) & 0.01 & {}[-0.12, 0.15] & 0.20 & 160.35 & .843\\
Method (HPP vs. CF) & 0.05 & {}[-0.05, 0.16] & 1.04 & 150.72 & .298\\
Days between Sessions & -0.01 & {}[-0.01, 0.00] & -1.97 & 151.38 & .051\\
\bottomrule
\end{tabular}
...
Trial Num. + Session + Condition & 0.31 & 0.27\\
Trial Num. + Session + Condition + Prev. Trial Looking & 0.30 & 0.28\\
Full Model & 0.29 & 0.26\\
\bottomrule
\end{tabular}
...
We find that ultimately about a third of the variance (\textasciitilde0.3) could be attributed to participant grouping in the data once including the within-participant predictors related to trial number, session, condition, and previous trial looking time.
