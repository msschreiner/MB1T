...
\caption{Relation between (log-based) looking time and (log-based) looking time on the previous trial. Each panel represents one of the trial numbers of the experiment (starting from the 2nd trial). The blue line represents a linear fit with 95\% CI error bands.}\label{fig:fig14}
\end{figure}
...
\leavevmode\vadjust pre{\hypertarget{ref-R-r2mlm}{}}%
