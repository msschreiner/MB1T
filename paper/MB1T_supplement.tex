...
This effect appears to be mainly driven by older infants showing some evidence of test-retest reliability for the HPP, \emph{r} = 0.45, \emph{p} = 0.02 (see Figure 3B).
...
\hypertarget{s11.-overall-looking-times-and-test-retest-ids-preference}{%
\section{S11. Overall looking times and test-retest IDS preference}\label{s11.-overall-looking-times-and-test-retest-ids-preference}}

\hypertarget{s11.1.-correlations-between-overall-looking-time-and-ids-preference}{%
\subsection{S11.1. Correlations between overall looking time and IDS preference}\label{s11.1.-correlations-between-overall-looking-time-and-ids-preference}}
...
\caption{Correlations between average looking time (in s) and IDS preference in (A) Session 1 and (B) Session 2.}\label{fig:sfig11}
\end{figure}

\hypertarget{s11.2.-does-average-looking-time-moderate-test-retest-reliability}{%
\subsection{S11.2. Does average looking time moderate test-retest reliability?}\label{s11.2.-does-average-looking-time-moderate-test-retest-reliability}}
...
{\centering \includegraphics{MB1T_supplement_files/figure-latex/sfig12-1} 

}

\caption{Correlations between average looking time (in s) and IDS preference in (A) Session 1 and (B) Session 2.}\label{fig:sfig12}
\end{figure}
