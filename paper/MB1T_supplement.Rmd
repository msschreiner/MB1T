...
```{r fig14, fig.cap="Relation between looking time (in s) and looking time on the previous trial. Each panel represents one of the trial numbers of the experiment (starting from the 2nd trial). The blue line represents a linear fit with 95% CI error bands.", fig.align="center"}
