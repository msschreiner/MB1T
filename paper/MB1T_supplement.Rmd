...
#create data frame with additional information on each lab's data collection status in relation to the preregistration and to MB1
additional.notes <- data.frame(
  Lab = c("babylab-potsdam", "babyling-oslo", "brookes-babylab", "InfantCog-UBC", "infantll-madison", "lancslab", "wsi-goettingen", "wsi-goettingen"),
  Method = c( "HPP","eye-tracking", "central fixation", "central fixation", "HPP", "eye-tracking", "central fixation", "HPP"),
  "Collection prior to preregistration" = c("No", "No", "No", "No", "No", "No", "Yes (n=14)", "No"),
  "MB1 as Session 1" = c("No", "No", "No", "Yes", "No", "No", "Yes", "No")
)
