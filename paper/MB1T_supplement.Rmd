...
```{r  sfig8, fig.cap="Correlations in average looking time (in ms) between Session 1 and 2 (A) overall, (B) by condition, and (C) by item.", fig.align="center",fig.height = 16, fig.width = 12}
