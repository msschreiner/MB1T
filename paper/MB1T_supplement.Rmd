...
Given that we found that restricting the sample to participants contributing at least 6 ADS and IDS trials in both sessions increased test-retest reliability, we conducted the central analyses with this more restricted infant sample.
...
```{r  sfig9, fig.cap="Correlations in average looking time (in s) between Session 1 and 2 by item.", fig.align="center",fig.height = 16, fig.width = 12}
corr_lt_p3
```
