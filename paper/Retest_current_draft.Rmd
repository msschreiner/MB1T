---
title             : "No evidence of test-retest reliability in infant-directed speech preference in a large pre-registered infant sample"
...
LOOKING_MEASURE <- "log" #how to compute aggregated looking time preferences per subject. raw = using raw (average) looking times. log = using log-transformed (average) looking times
...
plot_exclusion_dataset <- function(df,minimum_trials=1,Limaxes=c(-0.5,1.5)) {
  #create the dataset based on the minimum trial inclusion criterion
