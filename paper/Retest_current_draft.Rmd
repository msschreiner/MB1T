...
df_all<-df_all %>% filter(trial_error == "noerror")
...
n_exclude_session = length(unique(df_all$Subject))-n # Calculating Participants lost due to missing valid trial in either session 1 or session 2
