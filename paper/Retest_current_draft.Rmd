...
There was no significant difference in the magnitude of infants’ preference between the two test sessions, $\beta$=`r round(diff_session_coefs[2,1],3)`, *SE*=`r round(diff_session_coefs[2,2],2)`, *p*=`r printp(diff_session_coefs[2,5])`.
